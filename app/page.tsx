  ...
  return (
    <div className="bg-[#1e293b] min-h-screen letter-spa text-white">
      ...
      <header className="flex justify-between items-center px-10 py-6">
        ...
        <nav
          className={`md:flex space-x-8 mr-16 ${
            isOpen ? "block" : "hidden"
          } md:block`}
        >
          ...
          <Link href="/contact" className="hover:text-gray-400 mr-18">
            Contact
          </Link>
        </nav>
        <div className={`space-x-4 ${isOpen ? "block" : "hidden"} md:block`}>
          ...
          <Link href="/join-us">
            <button className="bg-blue-400 px-5 mr-8 py-3 rounded-l ml-5">
              Join Us
            </button>
          </Link>
        </div>
      ...
      <section className="text-center py-20 px-8 md:px-0 ">
        ...
        <h1 className="text-8xl md:text-6xl mt-12 font-bold tracking-wider">
          Selling on the
        </h1>
      ...
      <section className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-8 px-4 md:px-10 py-10 p-6">
        <div className="bg-white text-black  p-7 px-14 shadow-lg">
          ...
          <p className="text-gray-600 ">
            The gradual accumulation <br /> of information about atomic and{" "}
            <br /> small-scale behavior...
          </p>
        </div>
